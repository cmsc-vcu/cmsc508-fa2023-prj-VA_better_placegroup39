...
for num, values in data.items():
    ...
    insert_statements += f"INSERT INTO Transportation (isBikeRoute, isLightTrainRoute, startingZipcode, endingZipcode) VALUES ({is_bike_route}, {is_light_train_route}, {starting_zipcode}, {ending_zipcode});\n"
